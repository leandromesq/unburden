...
export const enDictionary: AppDictionary = {
  ...
  speedBenchmark: {
    ...
    benchmarkLadder: "Speed Ladder",
    globalModifiers: "Global modifiers",
    noPokemon: "Type a Pokemon to begin.",
    explicitComparator: "Pinned comparator",
    nearestBenchmark: "Focused tier",
    otherPokemon: (count) => `${count} more in this tier`,
    speSp: "Spe SP",
    stage: "Stage",
    ability: "Ability",
    nature: "Nature",
    ...
    copiedShareUrl: "Copied",
    clear: "Clear",
    pinComparator: "Pin",
    unpinComparator: "Unpin",
    wheelSelection: "Wheel selection",
    swapSides: "Swap sides",
    tiedTier: "Tied tier",
    pinnedOffTier: "Outside meta tiers",
    thresholdEmpty: "Select a Pokemon to see Speed thresholds.",
    thresholdUnavailable: "No Spe SP value moves first against this benchmark.",
    speedTie: "Speed tie.",
    movesFirst: "Moves first.",
    comparatorMovesFirst: "Comparator moves first.",
    ...
    sequenceBenchmark: "2. Benchmark",
    sequenceDecision: "Decision",
    subjectFirst: "Subject first",
    benchmarkFirst: "Benchmark first",
    referenceTier: "Reference tier",
    ladderContext: "Ladder context",
    ladderContextModifiersOpen:
      "Modifiers are open. Keep the decision strip as the source of truth, then use the ladder to confirm nearby tiers.",
  },
  testerLinks: {
