...
export const ptBRDictionary: AppDictionary = {
  ...
  speedBenchmark: {
    title: "Benchmark de Speed",
    description: "Compare tiers de Speed no level 50 contra perfis do meta VGC.",
    commandLabel: "Speed Prompt",
    commandPlaceholder: "basculegion choice scarf x aerodactyl -1 tailwind ~rain…",
    helpTrigger: "Mostrar referencia de sintaxe de Speed",
    helpTitle: "Sintaxe de Speed",
    helpDescription: "subject [speed tokens] x comparator [speed tokens] [~global tokens]",
    helpClose: "Fechar ajuda de Speed",
    subject: "Seu Pokemon",
    comparator: "Comparador",
    benchmarkLadder: "Escada de Speed",
    globalModifiers: "Modificadores globais",
    noPokemon: "Digite um Pokemon para começar.",
    explicitComparator: "Comparador fixado",
    nearestBenchmark: "Tier em foco",
    otherPokemon: (count) => `${count} a mais neste tier`,
    speSp: "Spe SP",
    stage: "Estágio",
    ability: "Ability",
    nature: "Nature",
    neutralNature: "Neutra",
    plusNature: "+ Speed",
    minusNature: "- Speed",
    tailwind: "Tailwind",
    ...
    copiedShareUrl: "Copiado",
    clear: "Limpar",
    pinComparator: "Fixar",
    unpinComparator: "Soltar",
    wheelSelection: "Selecao da roda",
    swapSides: "Trocar lados",
    tiedTier: "Tier empatado",
    pinnedOffTier: "Fora dos tiers do meta",
    thresholdEmpty: "Selecione um Pokemon para ver thresholds de Speed.",
    thresholdUnavailable: "Nenhum valor de Spe SP se move primeiro contra este benchmark.",
    speedTie: "Empate de Speed.",
    movesFirst: "Move primeiro.",
    comparatorMovesFirst: "Comparador move primeiro.",
    movesFirstTrickRoom: "Move primeiro sob Trick Room.",
    comparatorMovesFirstTrickRoom: "Comparador move primeiro sob Trick Room.",
    pokemonMovesFirst: (name) => `${name} move primeiro.`,
    ...
    sequenceDecision: "Decisão",
    subjectFirst: "Sujeito primeiro",
    benchmarkFirst: "Benchmark primeiro",
    referenceTier: "Tier de referência",
    ladderContext: "Contexto da ladder",
    ladderContextModifiersOpen:
      "Modificadores estão abertos. Use a faixa de decisão como fonte principal, depois confirme tiers próximos na ladder.",
  },
  testerLinks: {
  ...
  summary: {
    ...
    save: "Salvar",
    edit: "Editar",
    savedSets: "Sets Salvos",
    removeSet: (name) => `Remover ${name}`,
  },
  modifierSwitches: {
  ...
  resultsPanel: {
    ...
    midBulk: "Bulk Mid",
    maxBulk: "Bulk Max",
    guaranteedOhko: "OHKO garantido",
    ohkoRoll: "Roll de OHKO",
    guaranteedTwoHitPace: "Ritmo de 2HKO garantido",
    twoHitRoll: "Roll de 2HKO",
    comfortableSurvive: "Sobrevive com folga",
    chipDamage: "Dano de chip",
    koChance: "Chance de KO",
    damageRange: "Faixa de dano",
