...
export const SITE_SHARE_IMAGE_VERSION = "20260428";
export const SITE_OG_IMAGE_URL = `/opengraph-image-${SITE_SHARE_IMAGE_VERSION}`;
export const SITE_TWITTER_IMAGE_URL = `/twitter-image-${SITE_SHARE_IMAGE_VERSION}`;
